...
# Add script for user creation
sshpass -p debian ssh -o StrictHostKeyChecking=no debian@$1 'cat > add.sh' < add.sh
sshpass -p debian ssh -o StrictHostKeyChecking=no debian@$1 'chmod +x add.sh'
