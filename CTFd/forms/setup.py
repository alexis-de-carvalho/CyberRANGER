...
class SetupForm(BaseForm):
    ctf_name = StringField(
        _l("Event Name"), description=_l("The name of your CyberRange event/workshop")
    )
    ctf_description = TextAreaField(
        _l("Event Description"), description=_l("Description for the CyberRange")
    )
    ...
    ctf_logo = FileField(
        _l("Logo"),
        description=_l(
            "Logo to use for the website instead of a CyberRange name. Used as the home page button. Optional."
        ),
    )
    ...
    ctf_theme = SelectField(
        _l("Theme"),
        description=_l("CyberRange Theme to use. Can be changed later."),
    ...
    start = StringField(
        _l("Start Time"),
        description=_l("Time when your event is scheduled to start. Optional."),
    )
    end = StringField(
        _l("End Time"),
        description=_l("Time when your event is scheduled to end. Optional."),
    )
